...
__all__ = ['SMALLNORBMeta', 'SMALLNORB', 'SMALLNORBFiles']

# CAFFE_SMALLNORB_URL = "http://dl.caffe.berkeleyvision.org/caffe_smallnorb.tar.gz"

class SMALLNORBMeta(object):
    """
    Provide methods to access metadata for SMARLLNORB dataset.
    """

    def __init__(self, dir=None):
        if dir is None:
            dir = get_dataset_path('smallnorb_metadata')
        self.dir = dir
        mkdir_p(self.dir)
    ...
    #     fpath = download(CAFFE_SMALLNORB_URL, self.dir)
    ...
    def get_image_list(self, name, dir_structure='original'):
        ...
        Args:
            ...
            dir_structure (str): same as in :meth:`SMALLNORB.__init__()`.
        Returns:
    ...
    def get_per_pixel_mean(self, size=None):
        ...
        mean_file = os.path.join(self.dir, 'smallnorb_mean.binaryproto')
    ...
    def guess_dir_structure(dir):
        ...
        Args:
            dir(str): something like '/path/to/smallnorb/val'
        ...
        logger.info(
            "[SMALLNORB] Assuming directory {} has '{}' structure.".format(
                dir, dir_structure))
        return dir_structure


class SMALLNORBFiles(RNGDataFlow):
    """
    Same as :class:`SMALLNORB`, but produces filenames of the images instead of nparrays.
    ...
    def __init__(self, dir, name, meta_dir=None,
        ...
        if dir_structure is None:
            dir_structure = SMALLNORBMeta.guess_dir_structure(self.full_dir)

        meta = SMALLNORBMeta(meta_dir)
...
class SMALLNORB(SMALLNORBFiles):
    """
    Produces uint8 SMALLNORB images of shape [h, w, 3(BGR)], and a label between [0, 999].
    """
    def __init__(self, dir, name, meta_dir=None,
                 shuffle=None, dir_structure=None):
        """
        ...
        .. code-block:: none
            ...
            dir/
              train/
                ...
                ...
              val/
                SMALLLNORB_val_00000001.JPEG
                ...
              test/
                SMALLNORB_test_00000001.JPEG
                ...

        With the downloaded SMALLNORB_img_*.tar, you can use the following
        command to build the above structure:

        .. code-block:: none

            mkdir val && tar xvf SMALLNORB_img_val.tar -C val
            mkdir test && tar xvf SMALLNORB_img_test.tar -C test
            mkdir train && tar xvf SMALLNORB_img_train.tar -C train && cd train
        ...
        .. code-block:: none
            ...
            dir/
              ...
              test/
                ...
                ...
        """
        super(SMALLNORB, self).__init__(
            dir, name, meta_dir, shuffle, dir_structure)

    """
    There are some CMYK / png images, but cv2 seems robust to them.
    https://github.com/tensorflow/models/blob/c0cd713f59cfe44fa049b3120c417cc4079c17e3/research/inception/inception/data/build_smallnorb_data.py#L264-L300
    """
    def get_data(self):
        for fname, label in super(SMALLNORB, self).get_data():
...
try:
    ...
    SMALLNORB = create_dummy_class('SMALLNORB', 'cv2')  # noqa

if __name__ == '__main__':
    meta = SMALLNORBMeta()
    # print(meta.get_synset_words_5())

    ds = SMALLNORB('/home/wyx/data/fake_smallnorb/', 'train', shuffle=False)
    ds.reset_state()
